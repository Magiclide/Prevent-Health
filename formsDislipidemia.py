...
class predictsFormsDis(FlaskForm):
    ...
    diabetes=SelectField('diabetes', choices=[("0", "Possuo"), ("1", "Não Possuo"),("2", "Não sei")], validators=[DataRequired("Por favor selecione uma opção")])
    hipertensao=SelectField('hipertensao', choices=[("0", "Possuo"), ("1", "Não Possuo"),("0", "Não sei")], validators=[DataRequired("Por favor selecione uma opção")])
